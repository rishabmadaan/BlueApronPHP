...
<div class="services">
    <div class="container">
        <h1 class="animated fadeInLeftBig" data-wow-duration="1000ms" data-wow-delay="300ms">Add
            photo</h1>
        <form action="restaurant_photo_action.php" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="text" name="caption" class="form-control" id="categoryname"
